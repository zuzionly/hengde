/* ------------------------------------------------------------------------
	Important!
	This code has been modified from it's original version
	to validate as HTML5.
	
	HTML now like this:
	<a href="" data-gal="prettyPhoto[galname]">click me</a>
	
	jQuery now like this:
...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			theme: 'pp_default', /* light_rounded / dark_rounded / pp_default / dark_square / facebook */
		...
		*/
		$.prettyPhoto.initialize = function() {
			...
			if(settings.ie6_fallback && $.browser.msie && parseInt($.browser.version) == 6) settings.theme = "pp_default"; // Fallback to a supported theme for IE6
		...
		*/
		$.prettyPhoto.open = function(event) {
			if(typeof settings == "undefined"){ // Means it's an API call, need to manually get the settings and set the variables
				settings = pp_settings;
				if($.browser.msie && $.browser.version == 6) settings.theme = "pp_default"; // Fallback to a supported theme for IE6
