    ...
    if ( 'themes.php' == $pagenow && isset( $_GET['activated'] ) && true == $_GET['activated'] ) :
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($){
                var message = '<?php printf( __( '<p><strong>%s is now activated.</strong> The custom options panel is located under <a href="%s">Appearance > Site Options</a>.</p>', 'tt_theme_framework' ), esc_js( $theme_name ), add_query_arg( array( 'page' => 'siteoptions' ), admin_url( 'admin.php' ) ) ); ?>';
