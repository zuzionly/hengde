...
/*
* Modifications done
* Changed class name to truethemes_sidebar_generator,
* so as to prevent conflict with original plugin.
*
*/
...
class truethemes_sidebar_generator {
	...
	function truethemes_sidebar_generator(){
		...
		add_action('admin_print_scripts', array('truethemes_sidebar_generator','admin_print_scripts'));
	...
	function admin_page(){
		...
		<div class="wrap">
			<div id="icon-options-general" class="icon32"></div><h2>Sidebars</h2>
			<br />
