...
// Declare the global $user_ID var.
global $user_ID, $user_identity;

/**
 * Custom callback function for outputting the comments in the theme.
 *
 * @since 2.1.0
 *
 ...
 */
function truethemes_comments( $comment, $args, $depth ) {
        ...
        <div class="comment-wrap">
            <div class="comment-content" id="comment-<?php comment_ID(); ?>">
                <div class="comment-gravatar">
                    <?php echo get_avatar( $comment, '60', get_template_directory_uri() . '/images/global/img-default-grav.png' ); ?>
    ...
    <div id="respond">
        ...
        <div class="comment-cancel"><?php cancel_comment_reply_link(); ?></div><!-- end .comment-cancel -->
            ...
            <?php if ( get_option( 'comment_registration' ) && ! $user_ID ) : ?>
                <p><?php printf( __( 'You must be <a href="%s">logged in</a> to post a comment.', 'tt_theme_framework' ), add_query_arg( array( 'redirect_to' => urlencode( get_permalink() ) ), get_option( 'siteurl' ) . '/wp-login.php' ) ); ?></p>
            <?php else : ?>
