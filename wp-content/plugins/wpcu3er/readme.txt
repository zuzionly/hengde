...
* [installing wpCU3ER](http://www.youtube.com/watch?v=euCGKqLu-70&fmt=6)
* [Adding new project to wpCU3ER](http://www.youtube.com/watch?feature=player_embedded&v=WFW0yi8gSOQ&fmt=6)
* [Editing project using wpCU3ER](http://www.youtube.com/watch?feature=player_embedded&v=N3zQsb5HSuk&fmt=6)
* [Embedding CU3ER using TinyMCE](http://www.youtube.com/watch?feature=player_embedded&v=tQMLewqKMiA&fmt=6)
* [Embedding CU3ER using Template Tag](http://www.youtube.com/watch?v=x4WdhvPyq_U&feature=player_embedded&fmt=6)
* [Removing CU3ER branding in wpCU3ER](http://www.youtube.com/watch?feature=player_embedded&v=3f2a91djx-k&fmt=6)
...
* [wpCU3ER FAQ] (http://support.getcu3er.com/forums/20083586-wpcu3er-faq)

* [How to install wpCU3ER](http://www.youtube.com/watch?v=euCGKqLu-70&fmt=6)
* [How to add new CU3ER project to wpCU3ER](http://www.youtube.com/watch?feature=player_embedded&v=WFW0yi8gSOQ&fmt=6)
* [How to edit project settings in wpCU3ER](http://www.youtube.com/watch?feature=player_embedded&v=N3zQsb5HSuk&fmt=6)
* [How to embed CU3ER slider to WordPress page or post](http://www.youtube.com/watch?feature=player_embedded&v=tQMLewqKMiA&fmt=6)
* [How to embed CU3ER slider to WordPress template file](http://www.youtube.com/watch?v=x4WdhvPyq_U&feature=player_embedded&fmt=6)
* [How to remove CU3ER branding](http://www.youtube.com/watch?feature=player_embedded&v=3f2a91djx-k&fmt=6)
...
== Changelog ==
= 0.75 =
* new feature - added option to force javascript 3d version over flash
* new feature - added option to disable responsive slider
* new feature - added option to set project size in %
* bug fix - fixed bug for displaying images from posts

= 0.74 =
* fixed issue with detecting projects with javascript

= 0.73 =
* fixed update IP addresss, since we moved to a new server

= 0.72 =
* added support for displaying images from posts and image auto fit to slides option

= 0.71 =
* added CU3ER widget to easily add CU3ER to sidebars

= 0.70 =
* fixed creating simple javascript fallback images bug

= 0.69 =
* added support for Mozilla Firefox 10+ CSS 3D transitions

= 0.68 =
* added support if wp-content folder name is changed

= 0.67 =
* fixed bug with slide link targets

= 0.66 =
* fixed conflict bug with WordPress 3.3 causing blank login and admin dashboard screen
...
= 0.27 =
* bug fix – removed database field that is not used anymore, but could make an error with older versions of mysql
