...
<div class="wrap wrap-CU3ER">
	...
	<div class="block">
		...
		<div class="block-inner">
			<div class="transHalf noBorder">
				...
				<div class="inputs">
					<label for="width">Width:</label> <input type="text" name="settings[width]" id="width" size="7" value="<?php echo $slideshow['width'] ?>" /> <select name="settings[width_type]" id="width_type"><option value="px"<?php echo ($slideshow['width_type'] == 'px') ? ' selected="selected"' : ''; ?>>px</option><option value="%"<?php echo ($slideshow['width_type'] == '%') ? ' selected="selected"' : ''; ?>>%</option></select>
				</div>
				<div class="inputs">
					<label for="height">Height:</label> <input type="text" name="settings[height]" id="height" size="7" value="<?php echo $slideshow['height'] ?>" /> <select name="settings[height_type]" id="height_type"><option value="px"<?php echo ($slideshow['height_type'] == 'px') ? ' selected="selected"' : ''; ?>>px</option><option value="%"<?php echo ($slideshow['height_type'] == '%') ? ' selected="selected"' : ''; ?>>%</option></select>
				</div>
				...
				<?php if(cu3er__isFallback($baseUrl . '/fallback/')): ?>
				<div class="inputs">
					<label for="force3d">Display JS 3d version first:</label> <input type="checkbox" id="force3d" name="settings[force_js3d]" value="yes"<?php echo ($slideshow['force_js3d'] == 'yes') ? ' checked="checked"' : '' ?> />
				</div>
				<div class="inputs">
				...
				<div class="inputs">
					<label for="responsive">Responsive resize:</label> <input type="checkbox" id="responsive" name="settings[responsive]" value="yes"<?php echo ($slideshow['responsive'] == 'yes') ? ' checked="checked"' : '' ?> />
				</div>
				<?php endif; ?>
				<div class="textarea">
	...
	<div class="block">
		<div class="block-head">
			...
			<h4>Use posts images</h4> <span> Use images from posts</span>
		</div>
		<div class="block-inner">
			<div class="transHalf noBorder">
				<div class="inputs">
					<label for="use_post_images">Use post images:</label> 
					<input id="use_post_images" type="checkbox" name="default[Defaults][use_post_images]" value="yes"<?php echo ($default['use_post_images'] == 'yes') ? ' checked="checked"' : ''; ?> /> 
				</div>
				<div class="inputs">
					<label for="posts_count">Posts count:</label> <input type="text" name="default[Defaults][posts_count]" size="4" id="posts_count" value="<?php echo $default['posts_count'] ?>" />
				</div>
				<div class="inputs">
					<label>Posts image fit:</label>
					<input type="radio" name="default[Defaults][posts_fit]" value="default"<?php echo ($default['posts_fit'] == 'default') ? ' checked="checked"' : '' ?> /> Use from slides
					<input type="radio" name="default[Defaults][posts_fit]" value="inside"<?php echo ($default['posts_fit'] == 'inside') ? ' checked="checked"' : '' ?> /> Inside
					<input type="radio" name="default[Defaults][posts_fit]" value="outside"<?php echo ($default['posts_fit'] == 'outside') ? ' checked="checked"' : '' ?> /> Outside
				</div>
				<div class="submit">
					<input type="submit" class="button-primary"  value="Save Changes" name="Submit"> <span class="loading"></span>
				</div>
				<p class="description">Info: you can still set the transitions below, but images will be dynamically used from posts..</p>
			</div>
			<br class="clear"/> 
		</div>
	</div>
				...
				<div class="block-inner" style="display: none;" id="defaultSlidesAndTransitions">
					<div class="transHalf">
						...
						<div class="inputs">
							...
							<input type="radio" name="default[Defaults][fit]" value="default"<?php echo ($default['fit'] == 'default') ? ' checked="checked"' : '' ?> /> Default
							<input type="radio" name="default[Defaults][fit]" value="inside"<?php echo ($default['fit'] == 'inside') ? ' checked="checked"' : '' ?> /> Inside
							<input type="radio" name="default[Defaults][fit]" value="outside"<?php echo ($default['fit'] == 'outside') ? ' checked="checked"' : '' ?> /> Outside
						</div>
			...
			<div class="block">
				...
				<div class="block-inner" style="display: none;">
					<div class="transHalf">
						...
						<h4><span>Slide settings</span></h4>
						<div class="inputs"<?php echo ($original['fit'] == '') ? ' CU3ER-emptyValue' : ''; ?>>
							<label>Image fit:</label>
							<input type="radio" name="slide[<?php echo $i; ?>][fit]" value="default"<?php echo ($slide['fit'] == 'default') ? ' checked="checked"' : '' ?> /> Default
							<input type="radio" name="slide[<?php echo $i; ?>][fit]" value="inside"<?php echo ($slide['fit'] == 'inside') ? ' checked="checked"' : '' ?> /> Inside
							<input type="radio" name="slide[<?php echo $i; ?>][fit]" value="outside"<?php echo ($slide['fit'] == 'outside') ? ' checked="checked"' : '' ?> /> Outside
						</div>
